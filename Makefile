...
#    Updated: 2023/08/15 18:47:13 by rennacir         ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
GNL = $(addprefix parsing/get_next_line/, get_next_line_utils.c get_next_line.c)
TOOLS = $(addprefix parsing/tools/,free_stacks.c)
